...
export default function Contact() {
  return (
    <div className="bg-[#d9cbb7] min-h-screen flex flex-col items-center justify-center p-8">
      ...
      <div className="bg-[#9c8271] rounded-3xl shadow-2xl flex flex-col lg:flex-row w-full max-w-[1200px] p-8"> {/* Increased max-w */}
        {/* Left Section */}
        ...
        <div className="flex-1 bg-[#967860] p-8 rounded-3xl shadow-xl">
